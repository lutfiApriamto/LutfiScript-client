  ...
  const getModules = async () => {
    ...
    {/* moduls section start */}
      <section id="modules" className="w-full py-8 flex flex-col items-center justify-center">
        {module.map(module => (
        <Link to={`/lutfiscript/materi/${module._id}`} key={module._id} className="flex justify-between bg-white w-5/6 hover:bg-yellow-300 transition duration-300 text-center rounded-lg px-3 py-2 mb-4 sm:w-4/5 sm:px-4 sm:py-3 md:w-3/4 md:px-5 md:py-4 lg:w-3/5 lg:py-6  ">
