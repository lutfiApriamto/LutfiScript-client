...
const GamePage = () => {
    ...
    const dataQuizCard = [
        { id : 1, quiztitle : "Pengenalan Javascript", imageUrl : "/img/quiz1.jpg", link : "/lutfiscript/quiz" ,
    ...
    return (
        <>
        <section id="hero" className="w-full h-[100vh] flex items-center justify-center bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('/img/hero-quiz-page.jpg')"}}>
