...
const FormLogin = () =>{
    return (
        ...
        <p className="text-sm text-white mb-3 mt-2 block capitalize lg:text-lg lg:mb-4">don't have an account ? <a href="" className="text-yellow-300 italic font-bold">Register</a></p>
