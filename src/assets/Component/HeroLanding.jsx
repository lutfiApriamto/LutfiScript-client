const HeroLanding = (props) => {
    ...
    return (
        <>
        <section id="hero" className="w-full h-[45vh] sm:h-[60vh] md:h-[50vh] lg:h-[65vh] bg-cover bg-center bg-fixed flex items-center justify-center" style={{ backgroundImage: `url(${imageUrl})` }}>
